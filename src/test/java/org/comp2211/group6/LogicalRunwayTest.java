...
public class LogicalRunwayTest{
  ...
  public void testSetIndividualRecalculatedParameter(LogicalRunway logicalRunway, double tora, double toda, double asda, double lda, RunwayParameters expected) {
    ...
    assertTrue("Set Individual Recalculated Parameter Test Failed."
  ...
  private Object[] testDataForSetIndividualRecalculatedParameter(){
    return new Object[] {
        new Object[] {new LogicalRunway(1, 434, 'L', new RunwayParameters(1, 1, 1, 1)), 3660, 3661, 3662, 3663, new RunwayParameters(3660, 3661, 3662, 3663)},
        new Object[] {new LogicalRunway(9, 555, 'C', new RunwayParameters(3660, 3660, 3660, 3660)), 1001, 5678, 3344, 5454, new RunwayParameters(1001, 5678, 3344, 5454)},
        new Object[] {new LogicalRunway(10, 856, 'L', new RunwayParameters(1234, 1111, 4321, 2222)), 5621, 1321, 888, 4091, new RunwayParameters(5621, 1321, 888, 4091)},
        new Object[] {new LogicalRunway(11, 74, 'C', new RunwayParameters(1111, 2222, 3333, 4444)), 253, 990, 890, 2131, new RunwayParameters(253, 990, 890, 2131)},
        };
  }
}
