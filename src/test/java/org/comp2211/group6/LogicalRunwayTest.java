...
public class LogicalRunwayTest {
  ...
  /**
   * msgH: error message for invalid heading. msgDT: error message for invalid displaced threshold.m
   * msgP: error message for invalid position. msgRP: error message for getRecalculatedParameters(),
   * no recalculation is performed. msgSRP: error message for setRecalculatedParameter(String,
   * double), invalid parameter name.
   */

  private String msgH = "Error. Invalid heading, which should be an Integer between 1 and 36.";
  private String msgDT = "Error. Invalid displaced threshold, which should be non-negative.";
  ...
  public void testException(int heading, double displacedThreshold, char position, Class errorClass,
      String errorMsg) {
    if (errorClass != null)
  ...
  public void testGetParameters(int heading, double threshold, char position,
    ...
    assertEquals(
        "getParameters() Test Failed. Expected: " + printParameters(params) + " Actual: "
            + printParameters(logicalRunway.getParameters()),
        params, logicalRunway.getParameters());
  }

  /**
   * Test setRecalculatedParameters(p) & getRecalculatedParameters() if both are called sequentially
   * returns the object p passed in; if get method is called without set, returns null;
   */
  @Test
  ...
  public void testRecalculatedParameters(LogicalRunway logicalRunway,
    ...
    assertNull("Unset RecalculatedParameters Returns Null Test Failed.",
        logicalRunway.getRecalculatedParameters());

    logicalRunway.setRecalculatedParameters(paramsRecalculated);

    assertEquals(
        "RecalculatedParameters() Test Failed, including setter and getter." + "Expected: "
            + printParameters(paramsRecalculated) + " Actual: "
  ...
  public void testSetIndividualRecalculatedParameter(LogicalRunway logicalRunway, String name,
      double params, RunwayParameters expected, Class errorClass, String errorMsg) {
    if (errorClass != null)
    ...
    if (errorClass != null)
      assertNull(
          "setRecalculatedParameter(String, double) exception Test Failed." + "Expected: null"
              + " Actual: " + printParameters(logicalRunway.getRecalculatedParameters()),
          logicalRunway.getRecalculatedParameters());

    if (errorClass == null)
      assertTrue(
          "setRecalculatedParameter(String, double) Test Failed." + "Expected: "
  ...
  public boolean equalRunwayParameters(RunwayParameters expected, RunwayParameters actual) {
    if (expected.getTORA() == actual.getTORA() && expected.getTODA() == actual.getTODA()
        && expected.getASDA() == actual.getASDA() && expected.getLDA() == actual.getLDA())
      return true;
  ...
  public String printParameters(RunwayParameters params) {
    if (params != null)
      return "TORA: " + String.valueOf(params.getTORA()) + ", TODA: "
          + String.valueOf(params.getTODA()) + ", ASDA: " + String.valueOf(params.getASDA())
  ...
  private Object[] testDataForException() {
    return new Object[] {new Object[] {0, 307, 'L', IllegalArgumentException.class, msgH},
        ...
        new Object[] {1, 1, 'L', null, null}, new Object[] {36, 55, 'C', null, null}};
  }
  ...
  private Object[] testDataForRecalculations() {
    return new Object[] {
        new Object[] {new LogicalRunway(1, 377, 'L', new RunwayParameters(1, 1, 1, 1)),
            new RunwayParameters(3660, 3660, 3660, 3660)},
        new Object[] {new LogicalRunway(9, 444, 'C', new RunwayParameters(3660, 3660, 3660, 3660)),
            new RunwayParameters(34, 43, 56, 65)},
        new Object[] {new LogicalRunway(10, 111, 'L', new RunwayParameters(1234, 1111, 4321, 2222)),
            new RunwayParameters(789, 425, 5657, 5655)},
        new Object[] {new LogicalRunway(11, 333, 'C', new RunwayParameters(1111, 2222, 3333, 4444)),
            new RunwayParameters(1524, 6352, 8643, 2652)},
        new Object[] {new LogicalRunway(36, 454, 'R', new RunwayParameters(123, 234, 345, 567)),
            new RunwayParameters(4143, 7357, 3155, 3357)}};
  }

  private Object[] testDataForSetIndividualRecalculatedParameter() {
    return new Object[] {
        new Object[] {new LogicalRunway(1, 434, 'L', new RunwayParameters(1, 1, 1, 1)), "RTORA",
            3660, new RunwayParameters(3660, 1, 1, 1), null, null},
        new Object[] {new LogicalRunway(9, 555, 'C', new RunwayParameters(3660, 3660, 3660, 3660)),
            "RTODA", 5678, new RunwayParameters(3660, 5678, 3660, 3660), null, null},
        new Object[] {new LogicalRunway(10, 856, 'L', new RunwayParameters(1234, 1111, 4321, 2222)),
            "RASDA", 888, new RunwayParameters(1234, 1111, 888, 2222), null, null},
        new Object[] {new LogicalRunway(11, 74, 'C', new RunwayParameters(1111, 2222, 3333, 4444)),
            "RLDA", 9090, new RunwayParameters(1111, 2222, 3333, 9090), null, null},
        new Object[] {new LogicalRunway(36, 99, 'R', new RunwayParameters(123, 234, 345, 567)),
            "INVALID", 777, null, IllegalArgumentException.class, msgSRP}};
  }
}
