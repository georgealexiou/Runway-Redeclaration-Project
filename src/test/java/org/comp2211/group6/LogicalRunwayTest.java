...
public class LogicalRunwayTest{
   ...
   * msgDT: error message for invalid displaced threshold.m
  ...
  public void testGetParameters(int heading, double threshold, char position, RunwayParameters params) {
  ...
  public void testRecalculatedParameters(LogicalRunway logicalRunway, RunwayParameters paramsRecalculated) {
  ...
  public void testSetIndividualRecalculatedParameter(LogicalRunway logicalRunway, String name, 
    ...
    if(errorClass != null)
      assertNull("setRecalculatedParameter(String, double) exception Test Failed."
               + "Expected: null" + " Actual: " + printParameters(logicalRunway.getRecalculatedParameters()), 
  ...
  private Object[] testDataForGetIdentifier(){
    return new Object[] {
        new Object[] {1, 454, 'L', "01L"},
        new Object[] {9, 789, 'C', "09C"},
        new Object[] {10, 568, 'L', "10L"},
        new Object[]{11, 88, 'C', "11C"},
  ...
  private Object[] testDataForGetParameters() {
    return new Object[] {
        new Object[] {1, 78, 'L', new RunwayParameters(1, 1, 1, 1)},
  ...
  private Object[] testDataForRecalculations(){
    return new Object[] {
        new Object[] {new LogicalRunway(1, 377, 'L', new RunwayParameters(1, 1, 1, 1)), new RunwayParameters(3660, 3660, 3660, 3660)},
        new Object[] {new LogicalRunway(9, 444, 'C', new RunwayParameters(3660, 3660, 3660, 3660)), new RunwayParameters(34, 43, 56, 65)},
        new Object[] {new LogicalRunway(10, 111, 'L', new RunwayParameters(1234, 1111, 4321, 2222)), new RunwayParameters(789, 425, 5657, 5655)},
        new Object[] {new LogicalRunway(11, 333, 'C', new RunwayParameters(1111, 2222, 3333, 4444)), new RunwayParameters(1524, 6352, 8643, 2652)},
        new Object[] {new LogicalRunway(36, 454, 'R', new RunwayParameters(123, 234, 345, 567)), new RunwayParameters(4143, 7357, 3155, 3357)}
        };
  }

  private Object[] testDataForSetIndividualRecalculatedParameter(){
    return new Object[] {
        new Object[] {new LogicalRunway(1, 434, 'L', new RunwayParameters(1, 1, 1, 1)), "RTORA", 3660, new RunwayParameters(3660, 1, 1, 1), null, null},
        new Object[] {new LogicalRunway(9, 555, 'C', new RunwayParameters(3660, 3660, 3660, 3660)), "RTODA", 5678, new RunwayParameters(3660, 5678, 3660, 3660), null, null},
        new Object[] {new LogicalRunway(10, 856, 'L', new RunwayParameters(1234, 1111, 4321, 2222)), "RASDA", 888, new RunwayParameters(1234, 1111, 888, 2222), null ,null},
        new Object[] {new LogicalRunway(11, 74, 'C', new RunwayParameters(1111, 2222, 3333, 4444)), "RLDA", 9090, new RunwayParameters(1111, 2222, 3333, 9090), null, null},
        new Object[] {new LogicalRunway(36, 99, 'R', new RunwayParameters(123, 234, 345, 567)), "INVALID", 777, null, IllegalArgumentException.class, msgSRP}
        };
  }
}
