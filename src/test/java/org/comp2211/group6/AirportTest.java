...
public class AirportTest {
  ...
  public void testAddRemoveGetRunway(Set<Runway> runwaysToAdd, Set<Runway> expected1,
      Set<Runway> runwaysToRemove, Set<Runway> expected2, Class errorClass, String errorMsg) {
    if (errorClass != null)
  ...
  private Object[] testDataForConfigRunway() {
    ...
    return new Object[] {
        ...
        new Object[] {new HashSet<Runway>(Arrays.asList(r1, r5)),
            new HashSet<Runway>(Arrays.asList(r1, r5)), new HashSet<Runway>(Arrays.asList(r1)),
        ...
        new Object[] {new HashSet<Runway>(Arrays.asList(r1, r2, null, r5)),
            ...
            new HashSet<Runway>(Arrays.asList(r4, r5)), IllegalArgumentException.class, errorMsg},
        new Object[] {new HashSet<Runway>(Arrays.asList(r1, r2, r3, r4, r5)),
            new HashSet<Runway>(Arrays.asList(r1, r2, r3, r4, r5)),
            new HashSet<Runway>(Arrays.asList(r6)),
            new HashSet<Runway>(Arrays.asList(r4, r5, r3, r1, r2)), null, null}};
  }
